...
export function QuanTriDanhGia() {
  ...
  return <>
    ...
    <Card className="admin-table-card"><Table rowKey="id" loading={tai} dataSource={ds} scroll={{ x: 1100 }} columns={[
    ...
    <Modal className="admin-form-modal" open={Boolean(dangPhanHoi)} title={`Phản hồi ${dangPhanHoi?.hoTen || ''}`} okText="Lưu phản hồi" cancelText="Đóng" onCancel={() => setDangPhanHoi(null)} onOk={async () => {
