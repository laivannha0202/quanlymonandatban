...
export function QuanTriNhatKy() {
  ...
  return <>
    ...
    <Card><Table rowKey="id" loading={tai} dataSource={ds} scroll={{ x: 1050 }} columns={[
    ...
    <Drawer width={680} open={Boolean(chiTiet)} onClose={() => setChiTiet(null)} title="Chi tiết nhật ký">
